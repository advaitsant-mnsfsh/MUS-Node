  ...
  return (
    <div className="relative z-50">
      <button
        ...
        className="flex items-center justify-center w-10 h-10 bg-brand text-white border-2 border-border-main rounded-full hover:bg-brand-hover transition-all shadow-sm hover:shadow-md active:shadow-sm"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-auto min-w-[260px] bg-white rounded-lg border-2 border-black shadow-neo-sm py-1 origin-top-right animate-in fade-in zoom-in-95 duration-100 z-50">
          <div className="px-5 py-4 border-b-2 border-slate-100">
            <p className="text-sm text-text-secondary uppercase font-black tracking-wider mb-1">
              Signed in as
            </p>
          ...
          <button
            ...
            className="w-full text-left px-5 py-3 text-sm font-bold text-[#f56560] hover:bg-red-50 transition-colors flex items-center gap-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"

...
/** Mobile: readable column flow. md+: Figma-style absolute scenes. */
  ...
  return (
    ...
    >
      ...
      {/* ======================================================
            ...
            ====================================================== */}
      <section className="relative w-full max-w-full bg-[#FFFEF9] overflow-x-hidden">
        {/* —— Mobile: single column story (no absolute layout) —— */}
        <div className="md:hidden flex flex-col items-center gap-10 px-4 py-14 max-w-lg mx-auto w-full">
          <div className="flex flex-row flex-wrap justify-center items-end gap-6 w-full">
            <motion.div
            ...
            >
              <img
                ...
                className="object-contain w-32 h-32 sm:w-36 sm:h-36 rounded-full bg-[#E8E8E8]/80 p-2"
              />
            </motion.div>
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              {...MOBILE_STAGGER}
              transition={{ ...MOBILE_STAGGER.transition, delay: 0.06 }}
            >
              <p className="text-sm font-semibold text-[#1A1A1A] max-w-[11rem] leading-snug">
          ...
          <motion.h3
            className="text-xl sm:text-2xl font-bold text-[#1A1A1A] text-center leading-tight text-balance"
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            {...MOBILE_STAGGER}
            transition={{ ...MOBILE_STAGGER.transition, delay: 0.1 }}
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            {...MOBILE_STAGGER}
            transition={{ ...MOBILE_STAGGER.transition, delay: 0.14 }}
          >
            ...
            <img
              ...
              className="object-contain w-36 h-36 sm:w-40 sm:h-40 rounded-full bg-[#E8E8E8]/80 p-2"
            />
          </motion.div>
        </div>

        {/* —— Desktop: absolute scene —— */}
        <div className="hidden md:block relative w-full min-h-screen">
          <motion.div
            className="absolute left-[2%] sm:left-[4%] top-[14%] sm:top-[20%] -translate-y-1/2 max-w-[42vw] sm:max-w-none"
          ...
          >
            <img
              src="/About Page/s2-women.svg"
              alt="Tired woman character"
              className="object-contain w-[min(12.41644rem,42vw)] h-auto aspect-square"
            />
          </motion.div>

          <motion.div
            className="absolute flex flex-col-reverse sm:flex-row items-end sm:items-center gap-2 sm:gap-8 right-[2%] sm:right-[5%] top-0 max-w-[min(100%,20rem)] sm:max-w-none"
            initial={{ opacity: 0, scale: 0.8, y: 30 }}
            whileInView={{ opacity: 1, scale: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <p className="text-[0.88rem] md:text-[1.5rem] font-semibold text-[#1A1A1A] mb-0 sm:mb-2 text-right sm:text-left leading-tight">
              Is the design good or bad?
            </p>
            <img
              src="/About Page/s2-right-thinking-mein.svg"
              alt="Man thinking character"
              className="object-contain w-[min(12.41644rem,38vw)] h-auto shrink-0"
            />
          </motion.div>

          <motion.div
            className="absolute left-1/2 top-[26%] sm:top-[30%] -translate-x-1/2 -translate-y-1/2 text-center w-[min(100%,36rem)] px-3 sm:px-4"
            initial={{ opacity: 0, scale: 0.8, y: 30 }}
            whileInView={{ opacity: 1, scale: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <h3 className="text-[2rem] md:text-[2.3rem] font-bold text-[#1A1A1A] max-w-[49.31rem] mx-auto leading-tight text-balance">
              Will it work for your users or not?
            </h3>
          </motion.div>

          <motion.div
            className="absolute left-1/2 -translate-x-1/2 bottom-[8%] sm:left-[32%] sm:translate-x-0 w-[min(100%,22rem)] sm:w-auto"
            initial={{ opacity: 0, scale: 0.8, y: 30 }}
            whileInView={{ opacity: 1, scale: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
              <p className="text-[0.88rem] md:text-[1.5rem] font-semibold text-[#1A1A1A] text-center sm:text-left sm:whitespace-nowrap leading-tight">
                Will it hit success metrics?
              </p>
              <img
                src="/About Page/s2-reading-men-center.svg"
                alt="Man reading papers character"
                className="object-contain w-[min(12.41644rem,40vw)] h-auto shrink-0"
              />
            </div>
          </motion.div>
        </div>
      ...
      {/* ======================================================
            ...
            ====================================================== */}
      <section className="relative w-full max-w-full bg-[#FFFEF9] overflow-x-hidden">
        {/* Mobile: centered column + vertical timeline down the middle */}
        <div className="md:hidden relative py-14 px-4 w-full max-w-lg mx-auto">
          <div
            className="pointer-events-none absolute left-1/2 top-10 bottom-10 z-0 w-0 -translate-x-1/2 border-l-2 border-dashed border-[#1A1A1A]/25"
            aria-hidden
          />
          {[
            { t: "Teams keep guessing,", icon: "head" as const },
            { t: "metrics keep falling,", icon: "arrow" as const },
            { t: "users keep dropping...", icon: "users" as const },
          ].map((row, idx) => (
            <motion.div
              key={row.t}
              className="relative z-10 flex flex-col items-center text-center gap-3 pb-12 last:pb-4"
              initial={{ opacity: 0, y: 14 }}
              whileInView={{ opacity: 1, y: 0 }}
              {...MOBILE_STAGGER}
              transition={{ ...MOBILE_STAGGER.transition, delay: idx * 0.08 }}
            >
              <span
                className="relative z-10 shrink-0 w-3 h-3 rounded-full bg-[#FFFEF9] border-2 border-[#1A1A1A]/40 shadow-[0_0_0_6px_#FFFEF9]"
                aria-hidden
              />
              <p className="relative z-10 text-base font-semibold text-[#2A2A2A] leading-snug text-balance max-w-[min(100%,20rem)] px-2 bg-[#FFFEF9]">
                {row.t}
              </p>
              <div className="relative z-10 flex h-[4.25rem] w-[4.25rem] shrink-0 items-center justify-center rounded-full bg-[#FFFEF9] shadow-[0_0_0_10px_#FFFEF9]">
                {row.icon === "head" && (
                  <svg
                ...
                {row.icon === "arrow" && (
                  ...
                  >
                    <path
                      d="M40.0011 71.6658L17.7578 49.4224L20.6745 46.4566L37.907 63.7108V39.1124H42.0953V63.7424L59.3278 46.5058L62.2445 49.4224L40.0011 71.6658ZM37.907 33.2574V22.4458H42.0953V33.2574H37.907ZM37.907 16.5908V8.30078H42.0953V16.5908H37.907Z"
                      fill="#666666"
                    />
                  </svg>
                )}
        ...
        <div className="hidden md:block relative w-full min-h-screen">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <p className="text-[0.95rem] md:text-[1.5rem] font-semibold text-[#2A2A2A]">
              Teams keep guessing,
            </p>
      ...
      {/* ======================================================
            ...
            ====================================================== */}
      <section className="relative w-full max-w-full bg-[#FFFEF9] overflow-x-hidden md:min-h-screen">
        {/* Mobile: stacked bubbles → character → compact ? cloud */}
        <div className="md:hidden flex flex-col gap-10 px-4 py-14 max-w-md mx-auto w-full">
          <motion.div
          ...
          >
            {[
              ...
              <div
                key={line}
                className="bg-white border-2 border-[#1A1A1A] px-3 py-2.5 text-sm font-semibold text-[#1A1A1A] shadow-[3px_3px_0px_#1A1A1A] leading-snug text-center"
              >
                {line}
              </div>
            ))}
          ...
          <motion.div
            ...
            {...MOBILE_STAGGER}
            transition={{ ...MOBILE_STAGGER.transition, delay: 0.08 }}
          >
            <img
              src="/About Page/s4-women-center.svg"
              alt="Confused woman character"
              className="object-contain w-44 max-w-[70vw] h-auto rounded-full bg-[#E8E8E8]/60 p-3"
            />
          </motion.div>
          <motion.div
            ...
            {...MOBILE_STAGGER}
            transition={{ ...MOBILE_STAGGER.transition, delay: 0.12 }}
            aria-hidden
          >
            {[
              { size: "2.75rem", r: -12 },
              ...
              <span
                key={i}
                className="text-[#FBD24E] font-extrabold leading-none select-none"
                style={{ fontSize: q.size, transform: `rotate(${q.r}deg)` }}
              >
                ?
              </span>
            ))}
        ...
        <div className="hidden md:block">
          <div className="relative w-full" style={{ height: "45vh" }}>
            ...
            >
              ...
              <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[min(92vw,16rem)] sm:w-auto flex justify-center">
                <div className="bg-white border-2 border-[#1A1A1A] px-2.5 py-2 sm:px-4 sm:py-2.5 text-sm sm:text-lg md:text-[1.5rem] font-semibold text-[#1A1A1A] whitespace-normal sm:whitespace-nowrap shadow-[3px_3px_0px_#1A1A1A] text-center leading-snug">
                  Is it the copy?
                </div>
              </div>
            ...
            <div className="absolute left-1/2 top-[24%] sm:top-[30%] -translate-x-1/2 w-[min(14rem,55vw)]">
              <img
                src="/About Page/s4-women-center.svg"
                alt="Confused woman character"
          ...
          >
            {[
              { left: "1%", top: "40%", size: "3.2rem", rotate: -15 },
              { left: "6%", top: "62%", size: "3.8rem", rotate: 8 },
              { left: "13%", top: "18%", size: "7.5rem", rotate: -10 },
              { left: "20%", top: "55%", size: "4rem", rotate: 12 },
              { left: "32%", top: "22%", size: "11rem", rotate: -4 },
              { left: "44%", top: "52%", size: "5.5rem", rotate: 6 },
              { left: "52%", top: "12%", size: "4rem", rotate: -12 },
              { left: "60%", top: "35%", size: "9rem", rotate: 5 },
              { left: "70%", top: "58%", size: "3.5rem", rotate: -8 },
              { left: "77%", top: "15%", size: "3.8rem", rotate: 10 },
              { left: "88%", top: "28%", size: "7rem", rotate: -6 },
            ].map((q, i) => (
              <motion.span
      ...
      {/* ======================================================
            ...
            ====================================================== */}
      <motion.section
        className="relative flex w-full max-w-full min-h-[min(88dvh,460px)] flex-col items-center bg-[#FBD24E] px-4 pt-10 pb-0 text-center sm:px-8 sm:pt-12 md:min-h-[min(72dvh,880px)] md:pt-16 md:pb-0 isolate overflow-x-clip"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
      >
        ...
        {/* mt-auto in a column flex pins the speedometer to the section bottom (avoids absolute + min-h strip “floating”). */}
        <div
          className="pointer-events-none z-10 mt-auto flex w-full justify-center overflow-x-clip pb-0 md:overflow-visible md:pb-1"
          aria-hidden
        >
          <div className="relative flex w-[min(100%,min(220px,calc(100vw-2rem)))] max-w-[220px] translate-y-1.5 items-end justify-center sm:max-w-[248px] sm:translate-y-2 md:w-[min(100%,360px)] md:max-w-[360px] md:translate-y-2.5">
            <img
              src="/About Page/s5-meter-center.svg"
              alt=""
              className="relative z-[1] w-full object-contain object-bottom"
            />
            <div
              className="absolute bottom-0 left-1/2 z-[2] w-full -translate-x-[12.35%] scale-[1.08] sm:scale-[1.1] md:scale-[1.14]"
              style={{ transformOrigin: "12.35% 59.375%" }}
            >
              <motion.img
      ...
      <div className="relative w-full max-w-full overflow-x-hidden">
        ...
        <div className="absolute -top-10 sm:-top-14 right-2 sm:right-8 md:right-14 pointer-events-none z-10 hidden sm:block w-[min(42%,480px)] max-w-[min(480px,55vw)]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 399 650"
            fill="none"
        ...
        {/* ===== SECTION 6 ===== */}
        <section className="relative w-full max-w-full bg-[#FFFEF9] overflow-x-hidden pb-8 md:pb-0">
          {/* Mobile: same story, normal flow — no overlapping cards */}
          <div className="md:hidden px-4 py-14 max-w-md mx-auto w-full flex flex-col gap-8">
            <motion.div
              initial={{ opacity: 0, y: 12 }}
              whileInView={{ opacity: 1, y: 0 }}
              {...MOBILE_STAGGER}
            >
              <p className="text-lg font-bold text-[#1A1A1A] text-center leading-snug text-balance">
                We analyze the interface against 110+ proven interaction
                standards.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  badge: "bg-[#FCF8F8]",
                  scoreColor: "text-[#D86E6E]",
                },
                {
                  score: "70",
                  border: "border-[#444]",
                  badge: "bg-[#FEFBF2]",
                  scoreColor: "text-[#CAB34B]",
                },
                {
                  score: "90",
                  border: "border-[#D5D5D5]",
                  badge: "bg-[#F5FCF5]",
                  scoreColor: "text-[#7EC27E]",
                  faint: true,
                },
              ].map((c, idx) => (
                <motion.div
                  ...
                  {...MOBILE_STAGGER}
                  transition={{
                    ...MOBILE_STAGGER.transition,
                    delay: 0.05 * idx,
                  }}
                  className={`relative border-2 ${c.border} bg-white p-3 shadow-[2px_2px_0px_rgba(26,26,26,0.12)] ${c.faint ? "opacity-80" : ""}`}
                >
                  <div
                    className={`absolute -top-2.5 right-2 border ${c.border} ${c.badge} px-2 py-0.5 rounded-sm`}
                  >
                    <span className={`font-bold text-sm ${c.scoreColor}`}>
                      {c.score}
                      <span className="font-normal text-xs text-[#A6A6A6]">
                        {" "}
                        /100
                      </span>
                    </span>
                  </div>
                  <span className="text-[0.65rem] font-bold text-[#7B7B7B] uppercase tracking-wide flex items-center gap-1.5 mt-2">
                    <span className="w-2 h-2 rounded-full bg-[#7B7B7B]" />
                    Observation
                  </span>
                  <div className="mt-2 space-y-1">
                    <div className="h-0.5 w-full bg-[#E3E3E3]" />
                    <div className="h-0.5 w-[70%] bg-[#E3E3E3]" />
                    <div className="h-0.5 w-[55%] bg-[#E3E3E3]" />
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="hidden md:block relative w-full min-h-screen">
            ...
            <motion.div
              className="absolute top-[8%] sm:top-[18%] md:top-[28%] left-1/2 md:left-[40%] -translate-x-1/2 text-center w-[min(100%,28rem)] px-3 z-10"
              initial={{ opacity: 0, x: -80 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, margin: "-80px" }}
              transition={{ duration: 0.8, ease: [0.25, 0.46, 0.45, 0.94] }}
            >
              <p className="text-base sm:text-[1.35rem] md:text-[1.6rem] font-bold text-[#1A1A1A] leading-snug text-balance">
                We analyze the interface against
                <br />
            ...
            <motion.div
              className="absolute z-20 left-[3%] sm:left-[10%] md:left-[15%] top-[36%] sm:top-[40%] md:top-[44%] w-[min(18.69144rem,calc(100vw-1.5rem))] max-w-[18.69144rem]"
            ...
            >
              <div className="relative border border-[#A6A6A6] bg-white p-[0.70313rem] flex flex-col items-start gap-[0.35156rem] shadow-[2px_2px_0px_rgba(26,26,26,0.15)]">
                <div className="absolute -top-[13px] right-[-8px] border border-[#A6A6A6] bg-[#FCF8F8] px-2 py-0.5 whitespace-nowrap z-30">
                  <span className="font-bold text-[0.85rem] text-[#D86E6E]">
                    40
                    <span className="font-normal text-[0.6rem] text-[#A6A6A6]">
                      {" "}
                      /100
                    </span>
                  </span>
            ...
            <motion.div
              className="absolute z-30 left-1/2 -translate-x-1/2 top-[46%] w-[min(29.90625rem,calc(100vw-1.25rem))] md:left-[35%] md:translate-x-0 md:top-[50%]"
            ...
            >
              <div className="relative border-[1.5px] border-[#444] bg-white p-[1.125rem] flex flex-col items-start gap-[0.5625rem] shadow-[2px_2px_0px_rgba(26,26,26,0.15)]">
                <div className="absolute -top-[16px] right-[-10px] border-[1.5px] border-[#444] bg-[#FEFBF2] px-3 py-0.5 whitespace-nowrap z-30 shadow-sm">
                  <span className="font-bold text-[1.1rem] text-[#CAB34B]">
                    70
                    <span className="font-normal text-[0.7rem] text-[#888]">
                      {" "}
                      /100
                    </span>
                  </span>
            ...
            <motion.div
              className="absolute z-10 left-[6%] md:left-[30%] top-[62%] md:top-[72%] w-[min(14.95313rem,calc(100vw-2rem))] max-w-[14.95313rem]"
            ...
            >
              <div className="relative border border-[#D5D5D5] bg-white p-[0.5625rem] flex flex-col items-start gap-[0.28125rem] opacity-70 scale-95 origin-top-left shadow-[2px_2px_0px_rgba(26,26,26,0.15)]">
                <div className="absolute -top-[11px] right-[-6px] border border-[#D5D5D5] bg-[#F5FCF5] px-1.5 py-0 whitespace-nowrap z-30">
                  <span className="font-bold text-[0.75rem] text-[#7EC27E]">
                    90
                    <span className="font-normal text-[0.55rem] text-[#A6A6A6]">
                      {" "}
                      /100
                    </span>
                  </span>
            ...
            <motion.div
              className="absolute z-10 right-[3%] md:right-[10%] top-[52%] md:top-[56%] w-[min(14.95313rem,calc(100vw-2rem))] max-w-[14.95313rem]"
              initial={{ opacity: 0, scale: 0.6 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true, margin: "-40px" }}
              transition={{
            ...
            >
              <div className="relative border border-[#D5D5D5] bg-white p-[0.5625rem] flex flex-col items-start gap-[0.28125rem] opacity-60 shadow-[2px_2px_0px_rgba(26,26,26,0.15)]">
                <div className="absolute -top-[11px] right-[-6px] border border-[#D5D5D5] bg-[#FCF5F5] px-1.5 py-0 whitespace-nowrap z-30">
                  <span className="font-bold text-[0.75rem] text-[#D88A8A]">
                    50
                    <span className="font-normal text-[0.55rem] text-[#A6A6A6]">
                      {" "}
                      /100
            ...
            <motion.div
              className="absolute z-0 left-[48%] md:left-[55%] top-[70%] md:top-[75%] w-[min(12rem,calc(100vw-3rem))]"
            ...
            >
              <div className="relative border border-[#E5E5E5] bg-white/50 p-[0.5rem] flex flex-col items-start gap-[0.25rem] opacity-40 shadow-[1px_1px_0px_rgba(26,26,26,0.15)]">
                <div className="absolute -top-[10px] right-[-6px] border border-[#E5E5E5] bg-[#FCFAF5] px-1.5 py-0 whitespace-nowrap z-30">
                  <span className="font-bold text-[0.65rem] text-[#D8C78A]">
                    60
                    <span className="font-normal text-[0.5rem] text-[#A6A6A6]">
                      {" "}
                      /100
                    </span>
                  </span>
        ...
        <section className="relative w-full pb-20 bg-[#FFFEF9] flex flex-col gap-[3rem] items-center">
          ...
          >
            <p className="text-[1.35rem] md:text-[1.65rem] font-bold text-[#1A1A1A] leading-snug">
              Get Recommendations that are relevant to your organisation, your
              context, no generic bs!
            </p>
          </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span
                  ...
                  style={{ fontSize: "1.17188rem", fontWeight: 700 }}
                >
                  Recommendation
                </span>
              </div>
              <p
                className="text-[#3D3D3D] leading-relaxed m-0"
                style={{ fontSize: "1.17188rem", fontWeight: 400 }}
              >
                Receive targeted, actionable UX strategies tailored specifically
                to your unique product and audience.
              </p>
            </div>
          </motion.div>
      ...
      {/* end shared wrapper Sections 6+7 */}
    </div>
  );
};

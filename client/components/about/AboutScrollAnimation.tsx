...
const AboutScrollAnimation: React.FC = () => {
    return (
        <div id="about-scroll-narrative" className="w-full">
            ...
            ====================================================== */}
            <section className="relative w-full min-h-screen lg:min-h-[800px] lg:h-[800px] bg-[#FFFEF9] overflow-hidden">
                <div className="relative w-full max-w-[1440px] mx-auto h-full px-6">
            ...
            <section className="relative w-full min-h-screen bg-[#FFFEF9]">
                <div className="relative w-full max-w-[1440px] mx-auto h-full px-6 flex flex-col items-center justify-center">

                ...
                {isReportReady && (
                    <>
                        ...
                        <div className="relative">
                            {isLocked && !isAuthLoading && <AuthBlocker isUnlocked={false} onUnlock={() => setIsLocked(false)} auditUrl={url} auditId={auditId} />}
                                                    ...
                                                    <div className="rounded-xl border border-slate-200 bg-slate-50 shadow-sm relative overflow-hidden h-[450px]">
                                                        {!imageError && primaryScreenshotSrc ? (
                                                            <img
                                                                ...
                                                                alt="Preview"
                                                                onError={(e) => {
                                                                    console.error('[ReportDisplay] Image Load Failed:', e.currentTarget.src);
                                                                    setImageError(true);
                                                                }}
                                                            />
                                                        ) : (

...
import { Trophy, TrendingUp, Target, Swords, CheckCircle2, XCircle, Layers, Rocket, Palette, BrainCircuit, ScanEye, LayoutDashboard } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 break-inside-avoid pdf-item">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-lg font-bold text-slate-900">Competitors Winning Moves</h3>
                            </div>
                            <div className="space-y-4">

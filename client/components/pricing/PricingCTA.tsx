...
const PricingCTA = () => {
  ...
  return (
    <section className="w-full py-20 px-4 flex flex-col items-center justify-center gap-12 bg-[#FFFEF9] relative overflow-hidden">
      ...
      <button
        onClick={() => navigate("/")}
        className="inline-flex justify-center items-center gap-2 bg-[#F4D067] text-black text-2xl font-bold border-4 border-black px-8 h-16 w-72 shadow-[2px_2px_0px_0px_#000] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all group shrink-0 relative z-10"
      >
        Get your score
